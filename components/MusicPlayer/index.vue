      ...
      <div class="player__bd">
        <div id="song_info__info" class="bd-left">
          <img
            ...
            alt="晚风心里吹"
          />
          <div class="song_info__name">歌曲名： {{ activeMusic.songName }}</div>
          <div class="song_info__singer">歌手： {{ activeMusic.singer }}</div>
          <div class="song_info__album">专辑：{{ activeMusic.album }}</div>
        </div>
